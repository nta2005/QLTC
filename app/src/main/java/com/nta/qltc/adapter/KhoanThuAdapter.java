    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View bottomSheetView = LayoutInflater.from(context).inflate(R.layout.bottom_sheet_khoahoc,
                ...
                txtXemchiTiet.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        tien.setText(fm.format(gd.getSoTien()) + " VNĐ");
...
//                });
                        ...
                        ngayGd.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                DatePickerDialog datePickerDialog = new DatePickerDialog(context, android.R.style.Theme_Holo_Dialog_MinWidth, mDateSetListener, d, m, y);
                ...
                txtXoa.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        txt_Massage.setText("Bạn có muốn xóa " + list.get(position).getMoTaGd() + "?");
